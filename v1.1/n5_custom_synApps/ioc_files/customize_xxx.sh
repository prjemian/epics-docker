...
echo ""  >> ./optics.iocsh
echo "# monochromator"  >> ./optics.iocsh
echo iocshLoad\(\"\$\(OPTICS\)/iocsh/orient.iocsh\", \"PREFIX=\$\(PREFIX\), INSTANCE=1, M_TTH=m29, M_TH=m30, M_CHI=m31, M_PHI=m32, SUB=substitutions/orient_xtals.substitutions\"\)  >> ./optics.iocsh
